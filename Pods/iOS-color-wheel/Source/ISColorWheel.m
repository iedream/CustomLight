...
- (NSDictionary *)getTouchPoint {
    NSDictionary *dict = @{@"x":[NSNumber numberWithFloat:_touchPoint.x], @"y":[NSNumber numberWithFloat:_touchPoint.y]};
    return dict;
}

- (void)setCurrentTouchPoint:(NSDictionary *)dict {
